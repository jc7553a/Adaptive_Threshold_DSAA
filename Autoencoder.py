...
class Autoencoder(object):
    ...
    def _initialize_weights(self):
        ...
        #all_weights['w3'] = tf.Variable(tf.truncated_normal([self.n_hidden, self.n_hidden2], stddev = .001), name = 'weights2')
        #all_weights['b3'] = tf.Variable(tf.truncated_normal([self.n_hidden2], stddev = .001), name = 'biases2')
        return all_weights
